...
class Button {
    public:
        Button(ECSManager *ecsManager, std::string text, int x, int y, Font font, Texture2D textures[3], SCENE_TYPE type, ClickableActionType actionType, Scene *current_scene = nullptr, Sound *sound = nullptr);
